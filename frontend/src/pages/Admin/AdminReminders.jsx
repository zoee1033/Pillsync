...
import { getAdminReminders } from "../../services/adminService";
  ...
  useEffect(() => {
    const fetchReminders = async () => {
      ...
      try {
        ...
        setError("Failed to load platform reminders.");
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <PageContainer>
      <div className="space-y-6">
        ...
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-slate-800">System Reminders Overview</h2>
          <p className="text-sm text-slate-500">View actual prescribed reminder times across the entire platform.</p>
        </div>
